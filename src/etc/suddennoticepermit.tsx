...
const SuddenNoticepermit: React.FC<any> = (props) => {
    ...
    useEffect(() => {
        ...
        var query = url.split("?suddennoticeId=")[1];
        ...
        if (+pw === (500 * (+id)) + 10) {
            fetch(`https://peetsunbae.com/dashboard/edit/parentpermit`, {
                method: "post",
        ...
        <div className={styles.main}>

            {
                ...
                <div className={styles.text}>
                    사유 <span style={{ color: "#1b49af" }}>승인</span><br></br>처리 되었습니다.
                </div>
            }

            {
                ...
                <div className={styles.text}>
                    사유 <span style={{ color: "red" }}>승인 거절</span><br></br>처리 되었습니다.
                </div>
            }
...
export default SuddenNoticepermit;