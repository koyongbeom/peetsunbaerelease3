...
const columns: GridColDef[] = [
    ...
    { field: 'firstReply', headerName: '상황', width: 400, filterable: false, renderCell: renderCellExpand, editable: true },
    { field: 'secondReply', headerName: '최종처리', width: 400, filterable: false, renderCell: renderCellExpand, editable: true },
